...
{
    public partial class cluster_data_form : Form
    {
        public cluster_data_form()
        {
            InitializeComponent();
        }
        DataSet ds = new DataSet();
        private void cluster_data_form_Load(object sender, EventArgs e)
        {
            
            dataGridView1.DoubleBuffered(true);
            ds.ReadXml("xml_data_cluster.xml"); 
        ...
        {
            ds.AcceptChanges();
            ds.WriteXml("xml_data_cluster.xml");
        }
